				...
				<div class="categoria">
					<ul>
						...
						$tag_arguments = array(
							...
							foreach($tags as $thetags) {
								if($thetags->slug != $terms[0]->slug ) { echo '<li><a href="'.get_tag_link( $thetags->term_id ).'">'.$thetags->name.'</a> ';}
								else { echo '<li class="active"><a href="'.get_tag_link( $thetags->term_id ).'" class="' . $thetags->slug .'">'.$thetags->name.'</a></li>'; }
							}
						?>
					</ul>
				</div>
							...
							<div class="txt">
								<div>
									<h1>
										...
										<!-- <span><?php// the_field('opts_inout'); ?></span> -->
